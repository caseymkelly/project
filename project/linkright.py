...
lr_stops = {'Northgate Station': [47.701976, -122.328388, '1_990006', '1_990005'], 'Roosevelt Station': [47.676594, -122.315985, '1_990004', '1_990003'],
            ...
            'Westlake Station': [47.611597, -122.336666, '1_1121', '1_1108'], 'University Street Station': [47.607746, -122.335960, '1_565', '1_455'], 'Pioneer Square Station': [47.602669, -122.331318, '1_501'],
...
def next_train(lr_stops, direction, radius):
    nearby_lrstops = get_time_dist_to_lrstops(lr_stops, radius)
